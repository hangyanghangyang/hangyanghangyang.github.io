...
//Full-screen
// Using the element.requestFullscreen() method to make the media player fullscreen
// Adding a If...else if statement to perform different actions based on different browsers (because some browsers don't support the method yet)
...
//Exit full-screen
// Using the exitFullscreen() method to close fullscreen
...
//To listen whether the video is finished playing. If it is finished, close fullscreen and display the replay button.
media.addEventListener("ended", function() {
  exitFullscreen();
  replay.style.display="block";
})

//To listen whether the reply button is clicked. It it is, play the video.
...
//play.addEventListener('click', exampleFunction);
...
// Volume slider (in class)

//Placing an eventListener
